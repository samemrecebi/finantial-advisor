                    ...
                    <foreignObject x="41%" y="53%" width="240px" height="40px">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                placeholder="Paul"
                                className="w-full h-full px-4 py-2 text-black rounded border border-gray-300 focus:outline-none focus:border-blue-500 text-left" style={{ backgroundColor: '#D6E4FF' }}
                                disabled
                            />
                        </div>
                    </foreignObject>
