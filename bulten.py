...
# Bulletin number dosyası
bulletin_file = 'bulletin_number.txt'
...
if today.weekday() >= 5:
    ...
    print("Bugün resmi tatil")
else:
    # Bülteni indir ve yükle
    file_content, date_str = download_bulletin(today)
    upload_to_blob(file_content, date_str)
    print(f"Günlük Bülten {date_str}.pdf başarıyla yüklendi.")

# Çalıştırılan dizini yazdır
print(f"Script çalıştırılan dizin: {os.getcwd()}")
