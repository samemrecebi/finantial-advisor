...
const fewShotExamples = [
  {
    ...
    content: [
      {
        type: 'text',
        text: '1000 dolar ile hangi hisse senetlerine yatırım yapmalıyım?'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'Şu an en iyi döviz kuru nedir?'
      }
    ]
  },
  {
    ...
    content: [
      {
        type: 'text',
        text: 'Güncel döviz kurları sürekli değişmektedir. Şu an için en iyi döviz kuru bilgisi almak için döviz kurları sağlayıcılarından veya bankaların web sitelerinden güncel verilere bakabilirsiniz. Örneğin, USD/TRY kuru şu an 32.50 seviyesinde.'
      }
    ]
  }
];
